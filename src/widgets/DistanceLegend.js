...
class DistanceLegend extends Widget {
   ...
   */
  _bindEvent() {
    this._viewer.scene.preRender.addEventListener(this._updateContent, this)
  }
   ...
   */
  _unbindEvent() {
    this._viewer.scene.preRender.removeEventListener(this._updateContent, this)
  }
